...
const Sidebar = () => {
  return (
    <div className='text-gray-500 px-5 pt-5 pb-36 text-xs lg:text-sm border-r border-gray-900 overflow-y-scroll scrollbar-hidden h-screen sm:max-w-[12rem] lg:max-w-[15rem] hidden md:block'>
